// src/app/(content)/AI_HL/teacher-lessons/_components/ThreePane.jsx
"use client";
...
const BG_ACTIVE  = "bg-[#E0F7F6]";    // mint pastel selectat (AI HL)
const TEAL_DARK  = "#0f766e";         // accent închis (AI HL uses --ai-hl-dark)
  ...
  return (
    ...
    >
      ...
      {active && (
        <div className="mt-2">
          <Link
            href={`/AI_HL/teacher-lessons/lesson/${encodeURIComponent(l.id)}`}
...
export default function ThreePane({ topics }) {
  ...
  // 🔑 punem tema AI HL pe wrapper
  return (
    <div className="course-theme-ai-hl mt-2 rounded-2xl bg-white border border-slate-200 p-3 md:p-4">
