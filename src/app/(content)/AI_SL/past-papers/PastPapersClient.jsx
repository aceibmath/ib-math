...
export default function PastPapersClient({ yearsNew = [], yearsOld = [] }) {
  ...
  // new AI SL vs old Math SL
  const family = curr === "new" ? "ai-sl" : "math-sl";
  const baseHref =
    curr === "new" ? "/AI_SL/past-papers/" : "/MATH_SL/past-papers/";
  ...
  // culoarea închisă oficială AI SL din globals
  const DARK = "var(--ai-sl-dark)"; // ex. #B45309
  ...
  return (
    <div className="rounded-3xl ring-2 ring-[#0f6a75]/10 mb-5">
      <div className="rounded-[calc(1.5rem-2px)] border border-slate-200 bg-white/60 shadow-sm">
        ...
        {/* Grid sesiuni (carduri + Paper 1 / Paper 2) */}
                    ...
                    return (
                      <a
                        ...
                        className="
                          ...
                          transition
                          hover:bg-[var(--ai-sl-dark)]
                          hover:border-[var(--ai-sl-dark)]
                          hover:text-white
                        "
                      >
                        {`Paper ${p}`}
