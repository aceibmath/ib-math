// src/components/flashcards/FlashcardsSelector-ai-sl.jsx
"use client";
...
/** AI SL — TOPICS & SUBTOPICS (amber) */
const DATA = [
  { topic: "Number & Algebra",         subtopics: ["Number Skills", "Sequences & Series"] },
  { topic: "Functions",                subtopics: ["Linear Equations", "Properties of Functions"] },
  { topic: "Geometry & Trigonometry",  subtopics: ["Trigonometry", "Voronoi Diagrams"] },
...
export default function FlashcardsSelectorAISL() {
  ...
  const startHref = useMemo(() => {
    ...
    return `/AI_SL/flashcards/deck?${qs}`;
  ...
  return (
    // Injectăm tema AI SL (amber) ca variabile CSS locale pentru stylesheet-ul generic
    <div
      className={`${s.fcRoot} pt-2 pb-4 px-4 md:pt-3 md:pb-5 md:px-5`}
      style={{
        "--sel-light": "var(--ai-sl-light, #FEF3C7)",
        "--sel-dark":  "var(--ai-sl-dark,  #B45309)",
      }}
    >
      {/* TOPICS (5 coloane) */}
